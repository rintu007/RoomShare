<?php
                    ...
                    $_SESSION["pwfmail"]=$_POST['email'];
                    $_SESSION["pwfpass"]=$_POST['pass'];
                    ...
                    if(($c==0) && ($p==0))
                    {
                        ...
                        echo ".<br>Entered email ID is ".$_SESSION["pwfmail"];
                        header("refresh:1;url=pwf1.html");
